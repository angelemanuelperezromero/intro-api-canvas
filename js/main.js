...
function draw_path() {
  ...
  function draw_bez() {
    const canvas = document.getElementById("canvas_bez");
    if (canvas.getContext) {
      const ctx = canvas.getContext("2d");
  ...
  function draw_bezcuad() {
    const canvas = document.getElementById("canvas_bezcuad");
    if (canvas.getContext) {
      const ctx = canvas.getContext("2d");
  ...
  function draw_combina() {
    const canvas = document.getElementById("canvas_combina");
    if (canvas.getContext) {
      const ctx = canvas.getContext("2d");
